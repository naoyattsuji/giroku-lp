...
const steps: Step[] = [
  {
    ...
    image: { src: "/guide/step-01-start.png", alt: "録音ボタンを押す", w: 2080, h: 900 },
  },
  {
    num: "2",
  ...
  },
  {
    ...
    image: { src: "/guide/step-03-live.png", alt: "録音中のライブ文字起こし", w: 2080, h: 760 },
  },
  {
    num: "4",
    title: "音源はその場でオン/オフできる",
    desc: "マイクだけ、パソコンの音だけ、を録りたいときはワンクリックでミュートできます。",
    image: { src: "/guide/step-04-mute.png", alt: "マイクをミュートする", w: 2080, h: 200 },
  },
  {
    num: "5",
    title: "終わったら、停止するだけ",
    desc: "「停止」を押すと、あとは自動で保存・文字起こしまで進みます。",
    image: { src: "/guide/step-05-stop.png", alt: "録音を停止する", w: 2080, h: 200 },
  },
  {
    num: "6",
    title: "「議事録を作成」で、AIがまとめる",
    desc: "決まったこと・やることを、AIが自動で整理します（無料でも毎月2件まで作成可）。",
    image: { src: "/guide/step-06-create.png", alt: "議事録を作成ボタン", w: 2080, h: 320 },
  },
  {
    num: "7",
  ...
  },
  {
    ...
    image: { src: "/guide/step-08-history.png", alt: "履歴画面での検索とお気に入り", w: 2080, h: 920 },
  },
  {
    num: "9",
    title: "複数まとめて、フォルダ移動や削除も",
    desc: "「選択」でチェックを付けると、まとめてフォルダに移動したりゴミ箱に入れたりできます。",
    image: { src: "/guide/step-09-select.png", alt: "複数選択して一括操作", w: 2080, h: 920 },
  },
  {
    num: "10",
